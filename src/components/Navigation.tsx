  ...
  const getNavItems = () => {
    ...
    if (user) {
      if (userRole === 'customer') {
        baseItems.push({ path: "/my-services", label: "My Services", icon: Settings });
      } else if (userRole === 'subcontractor') {
        baseItems.push({ path: "/subcontractor-dashboard", label: "Dashboard", icon: Settings });
      } else if (userRole === 'admin') {
        baseItems.push({ path: "/admin", label: "Admin Portal", icon: Shield });
      }
    }
