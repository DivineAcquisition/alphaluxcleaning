...
const SPLIT_TIERS = [
  {
    ...
    yourShare: '40%',
    price: 'Free',
    features: ['Basic job assignments', 'No guaranteed jobs', 'Standard support'],
    isPopular: false,
  },
  {
    id: '50_50',
    ...
    yourShare: '50%',
    price: '$10/month',
    features: ['Priority job assignments', '10 guaranteed jobs/month', 'Priority support'],
    isPopular: true,
  },
  {
    id: '35_65',
    ...
    yourShare: '65%',
    price: '$50/month',
    features: ['First priority on all jobs', '15 guaranteed jobs/month', 'Premium support', 'Performance bonuses'],
    isPopular: false,
  },
];
