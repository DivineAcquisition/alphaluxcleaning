...
export const ServiceIncluded = ({ cleaningType, serviceType }: ServiceIncludedProps) => {
  const getServiceDetails = () => {
    if (cleaningType === "deep") {
      return {
        ...
        included: [
          "Dust open shelves, ceiling fans, air vents, baseboards, windowsills, and mini blinds",
          "Dust and polish furniture",
          "Clean mirrors, picture glass, inside sliding glass doors",
          "Bathroom: Clean tubs, shower doors, toilet, sinks, and countertops, mop floor",
          "Kitchen: Clean top and front of stove and burners",
          "Clean top, front, sides and inside of refrigerator",
          "Load dishwasher or hand wash dishes (breakfast dishes or dishes from night before)",
          "Clean kitchen countertops, sink, small appliances and microwave",
          "Collect and dispose of trash",
          "Sweep and mop all floors",
          "Vacuum all carpet areas",
          "Make beds or change bed linens if clean ones are left out",
          "Fold up to two baskets of laundry"
        ],
      ...
      return {
        ...
        included: [
          "Kitchen: Clean and disinfect kitchen, wipe countertops",
          "Kitchen: Wash small amount of dishes or load dishwasher",
          "Kitchen: Wipe down all appliances and inside/out of microwave",
          "General House: Dust and polish furniture throughout house",
          "General House: Make beds",
          "General House: Sweep and mop floors",
          "General House: Vacuum carpeted areas",
          "General House: Fold up to 2 baskets of clothes",
          "Bathrooms: Clean, disinfect and sanitize bathrooms",
          "Bathrooms: Clean toilets",
          "Bathrooms: Scrub bathtubs and showers",
          "Bathrooms: Wipe down countertops and inside sinks",
      ...
      <CardContent className="space-y-6">
        ...
        <div className="pt-4 border-t text-center">
          <p className="text-sm text-muted-foreground">
            Bay Area Cleaning Professionals | (281) 201-6112 / (281) 932-0616
          </p>
          <p className="text-sm text-muted-foreground">
            Baytown, TX 77521 | admin1@bayareacleaningpros.com
          </p>
        </div>
      </CardContent>
    </Card>
