          ...
          >
            ...
            <div className="mb-6">
              <div className="flex items-baseline gap-2 mb-2">
                <span className="text-4xl md:text-5xl font-bold text-foreground">$250</span>
              </div>
              <p className="text-sm text-muted-foreground">
                One-time deep clean for homes up to 2 bed/2 bath or ~1,200–1,500 sq ft
              </p>
            </div>
          ...
          <Card
            className={`relative p-6 md:p-8 cursor-pointer transition-all duration-200 hover:shadow-lg border-2 ${
              selectedOffer === '90_day_plan'
                ? 'border-primary shadow-lg'
                : 'border-primary/30 hover:border-primary shadow-md'
            }`}
            onClick={() =>
              handleSelectOffer(
                '90_day_plan',
          ...
          >
            ...
            <div className="mb-6">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-4xl md:text-5xl font-bold text-foreground">$699</span>
              </div>
              <p className="text-sm text-muted-foreground mb-2">≈ $174 per visit</p>
              <p className="text-sm text-muted-foreground">
