-- Fix split_tier issue in subcontractors table and add missing columns to tier_system_config
UPDATE public.subcontractors SET split_tier = COALESCE(split_tier, tier_level, 1) WHERE split_tier IS NULL;
