...
('Payment Successful SMS', 'sms', NULL, 'Payment confirmed! Your cleaning service for {{service_date}} is all set. We''ll notify you when your cleaner is assigned and on their way. AlphaLux Clean - {{customer_name}}', ARRAY['order_status_changed'], '{"customer_name": "string", "service_date": "date"}'),
...
('Service Started SMS', 'sms', NULL, 'Your cleaner {{cleaner_name}} has arrived and started your cleaning service. Estimated completion: {{estimated_completion}}. Enjoy your day! - AlphaLux Clean', ARRAY['booking_status_changed'], '{"cleaner_name": "string", "estimated_completion": "string"}'),

('Service Completed SMS', 'sms', NULL, 'Your cleaning is complete! How did we do? Rate your experience: {{feedback_link}}. Thank you for choosing AlphaLux Clean, {{customer_name}}!', ARRAY['booking_status_changed'], '{"customer_name": "string", "feedback_link": "string"}'),
...
('Application Approved SMS', 'sms', NULL, 'Congratulations {{applicant_name}}! Your application has been approved. Click here to complete your onboarding: {{onboarding_link}}. Welcome to the AlphaLux Clean team!', ARRAY['application_status_changed'], '{"applicant_name": "string", "onboarding_link": "string"}'),
...
-- Email templates  
('Order Confirmation Email', 'email', 'Your AlphaLux Clean Service is Confirmed!', 'Dear {{customer_name}},\n\nThank you for choosing AlphaLux Clean! Your service has been confirmed:\n\nOrder #: {{order_id}}\nService Date: {{service_date}}\nAmount: ${{amount}}\n\nWe will assign a cleaner to your job and notify you 24 hours before your service.\n\nBest regards,\nAlphaLux Clean Team', ARRAY['order_created'], '{"customer_name": "string", "order_id": "string", "service_date": "date", "amount": "number"}')
