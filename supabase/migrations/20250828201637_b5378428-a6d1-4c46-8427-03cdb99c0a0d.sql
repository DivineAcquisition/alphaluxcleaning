...
SET 
  ...
  END,
  reviews_required = CASE
    WHEN tier_level = 1 THEN 0
    WHEN tier_level = 2 THEN 10
    WHEN tier_level = 3 THEN 20
  END,
  jobs_required = CASE
    WHEN tier_level = 1 THEN 0
    WHEN tier_level = 2 THEN 15
    WHEN tier_level = 3 THEN 25
  END
...
INSERT INTO public.tier_system_config (
  ...
  reviews_required = EXCLUDED.reviews_required,
  jobs_required = EXCLUDED.jobs_required,
  is_active = EXCLUDED.is_active;

-- Update the get_tier_benefits function to support 4 tiers with correct structure
