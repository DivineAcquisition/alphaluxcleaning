...
BEGIN
    ...
    SELECT json_build_object(
        'stats', json_build_object(
            ...
            'active', (SELECT COUNT(*) FROM subcontractors WHERE account_status = 'active'),
            ...
            'alerts', (SELECT COUNT(*) FROM subcontractors WHERE account_status = 'inactive' OR tier_level = 1),
        ...
        'analytics', json_build_object(
            ...
            'topPerformers', (
                ...
                GROUP BY s.id, s.full_name, s.hourly_rate
                LIMIT 5
            )
        ),
        'notifications', (
