...
-- 1. Add unique constraint to user_roles to prevent multiple conflicting roles per user
ALTER TABLE public.user_roles DROP CONSTRAINT IF EXISTS user_roles_user_id_key;
ALTER TABLE public.user_roles ADD CONSTRAINT user_roles_user_id_unique UNIQUE (user_id);

-- 2. Update all database functions with proper search_path for security
...
-- 3. Add security logging table for audit trail
...
-- 4. Add updated_at trigger to security_logs
