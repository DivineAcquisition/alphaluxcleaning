...
//
// Ported from the Novara booking system so every GHL contact lands with
// a clean E.164 number (+1XXXXXXXXXX). GHL silently drops contacts /
// fails dedupe when the phone isn't E.164, which is one of the ways the
// PIT sync "looked broken" — contacts were created without a phone.
...
/** National display for human-readable fields: (301) 346-8452 */
