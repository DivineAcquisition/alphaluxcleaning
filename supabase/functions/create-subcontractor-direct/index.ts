...
async function hashSSN(ssn: string): Promise<{ hash: string; last4: string }> {
  ...
  const data = encoder.encode(cleanSSN + "SALT_BACP_2024");
...
serve(async (req) => {
  ...
  try {
    ...
    <head>
        <meta charset="utf-8">
        <title>Welcome to Bay Area Cleaning Professionals</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
            ...
            <p>Congratulations! You've been added to our Bay Area Cleaning Professionals network as a <strong>${tierConfig.tier_name}</strong> subcontractor.</p>
            ...
            <p style="margin-bottom: 0;">
                ...
                <strong>Bay Area Cleaning Professionals</strong>
            </p>
        </div>
    </body>
    </html>
