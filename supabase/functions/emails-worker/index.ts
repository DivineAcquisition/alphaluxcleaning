...
const FROM = Deno.env.get("EMAIL_FROM") || "AlphaLuxClean <noreply@info.alphaluxcleaning.com>";
const REPLY_TO = Deno.env.get("EMAIL_REPLY_TO") || "support@info.alphaluxcleaning.com";
