...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Payment method ID received", { payment_method_id });
    ...
    logStep("Payment method ownership verified", { customerId });
    ...
    logStep("Default payment method updated successfully", { payment_method_id });
    ...
    logStep("ERROR in set-default-payment-method", { message: errorMessage });
